...
public class AnalgesicosTipo1 extends Medicamentos {

    private Double valorDescuento=0.05;
    private Double CostoUnitarioPorUnidad=5000.0;
    private Double DescuentoCompra=1000.0;

    public AnalgesicosTipo1(String nombre, Double precioUnitarioSinIva, String registroINVIMA, String fabricante, LocalDate fechaVencimiento, LocalDate fechaFabricacion) {
    ...
    public Double calcularCostoUnitario(Integer cantidad) {
        if(cantidad<1){
            ...
            return null;
               ...
               this.CostoUnitarioPorUnidad=this.CostoUnitarioPorUnidad*cantidad;
            }
